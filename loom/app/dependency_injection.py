...
from loom.kernel.artifact_service import ArtifactService
from loom.kernel.participant_resolver import ParticipantResolver
from loom.kernel.policy_engine import PolicyEngine
from loom.kernel.state_partition_service import StatePartitionService
...
from loom.memory.topology_service import MemoryTopologyService
...
from loom.registries.memory_edge_registry import MemoryEdgeRegistry
from loom.registries.memory_group_registry import MemoryGroupRegistry
from loom.registries.memory_membership_registry import MemoryMembershipRegistry
...
class Container:
    def __init__(self, settings: Settings):
        ...
        self.memory_group_registry = MemoryGroupRegistry(self.repositories, self.role_registry)
        self.memory_membership_registry = MemoryMembershipRegistry(
            self.repositories,
            self.memory_group_registry,
            self.role_registry,
        )
        self.memory_edge_registry = MemoryEdgeRegistry(
            self.repositories,
            self.memory_group_registry,
            self.role_registry,
        )
        ...
        self.model_router = ModelRouter(
            ...
            self.repositories.organization,
            self.role_registry,
        )
        ...
        self.state_partition_service = StatePartitionService(self.repositories)
        self.artifact_service = ArtifactService(self.repositories)
        ...
        self.memory_topology_service = MemoryTopologyService(
            self.memory_group_registry,
            self.memory_membership_registry,
            self.role_registry,
        )
        self.step_runner.memory_service = self.memory_service
        self.step_runner.memory_topology_service = self.memory_topology_service
        self.execution_coordinator.memory_service = self.memory_service
        self.execution_coordinator.memory_topology_service = self.memory_topology_service
        ...
        self.organization_runtime_service = OrganizationRuntimeService(self.settings, self.repositories)
    ...
    def shutdown(self) -> None:
        ...
        self.organization_runtime_service.shutdown()
